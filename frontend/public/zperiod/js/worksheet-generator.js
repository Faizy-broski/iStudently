...
const WORKSHEET_PHRASE_MAP = {
    ...
    'Generated by Jperiod': {
        'zh-Hant': '由 Jperiod 生成',
        fr: 'Genere par Jperiod',
        ru: 'Сгенерировано в Jperiod',
        fa: 'تولید شده توسط Jperiod',
        ur: 'Jperiod کی جانب سے تیار کردہ',
        tl: 'Nabuo ng Jperiod'
    }
};
...
function renderWorksheet(worksheet, mode) {
    ...
    html += `
            <div class="worksheet-footer">
                <span>${tr('Generated by Jperiod', '由 Jperiod 生成')}</span>
            </div>
        </div>
    `;
...
function exportToPDF() {
    ...
    const title = tr('Jperiod — Balancing Chemical Equations Worksheet', 'Jperiod — 化学方程式配平练习');
        ...
        <tbody>
            <tr>
                <td class="print-content">
                    ...
                    <div class="doc-footer">Generated by Jperiod</div>
