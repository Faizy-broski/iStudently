    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (promises.length > 0) {
                ...
                toast.success(`${promises.length} expense(s) saved`)
                mutate()
            } else {
            ...
            <div className="container mx-auto py-6">
                <Card>
                    <CardContent className="pt-6">
                        <p className="text-muted-foreground text-center">Please select a campus to manage expenses.</p>
                    </CardContent>
                </Card>
            </div>
        )
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Track operational costs and money going out • {selectedCampus.name}
                    </p>
                </div>
                    ...
                    {isLoading ? (
                        ...
                        <>
                            {rows.length === 0 || (rows.length === 1 && rows[0].isNew && !rows[0].title) ? (
                                <p className="text-muted-foreground mb-4">No expenses were found.</p>
                            ) : null}
                            <Table>
                                <TableHeader>
                                    <TableRow>
