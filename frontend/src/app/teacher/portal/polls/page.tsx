      ...
      const formattedResponses: portalApi.PollResponseDTO[] = poll.questions
        ...
        .map(q => {
          ...
          return {
            ...
            selected_options: ['single_choice', 'multiple_choice'].includes(q.question_type) ? (Array.isArray(answer) ? answer : [answer]) : undefined,
                    ...
                    {poll.questions?.map((question, qIndex) => (
                      <div key={question.id} className="space-y-3">
                        ...
                        {question.question_type === 'single_choice' && (
                          <RadioGroup value={responses[poll.id]?.[question.id] || ''} onValueChange={(value) => handleResponseChange(poll.id, question.id, value)}>
