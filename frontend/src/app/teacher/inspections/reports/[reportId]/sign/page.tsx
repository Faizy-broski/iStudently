...
export default function TeacherSignReportPage() {
  ...
  return (
    <div className="p-3 sm:p-6 max-w-3xl mx-auto space-y-5">
      <Link href="/teacher/inspections/reports" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700">
