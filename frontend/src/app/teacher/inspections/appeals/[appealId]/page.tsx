...
export default function TeacherAppealDetailPage() {
  ...
  return (
    <div className="p-3 sm:p-6 max-w-3xl mx-auto space-y-5">
      <Link href="/teacher/inspections/appeals" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700">
        <ArrowLeft className="h-4 w-4" /> {t('back_to_appeals')}
      </Link>
      {appealId && <AppealThreadView appealId={appealId} />}
    </div>
  )
}
