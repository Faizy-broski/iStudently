    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between print:hidden">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Official academic report card</p>
        </div>
        {reportCard && (
      ...
      {!reportCard ? (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-muted-foreground">No report card available</p>
          </CardContent>
        </Card>
      ) : (
        <>
          <Card>
            <CardContent className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div><p className="text-muted-foreground">Student</p><p className="font-semibold">{reportCard.student.name}</p></div>
              ...
              <div><p className="text-muted-foreground">School</p><p className="font-semibold">{reportCard.student.school_name}</p></div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <FileText className="h-5 w-5" /> Subject Results
              </CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <table className="w-full text-sm">
                  <thead className="border-b">
                    <tr className="text-xs text-muted-foreground uppercase">
                      ...
                      <th className="text-right py-3 pr-4 font-semibold">Obtained</th>
                      <th className="text-right py-3 pr-4 font-semibold">Total</th>
                      <th className="text-right py-3 pr-4 font-semibold">%</th>
