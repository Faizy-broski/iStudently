...
import { markPortalItemViewed, getViewedPortalItems } from "@/lib/utils/portal-storage"

export default function StudentPortalNotesPage() {
          ...
          {notes.map((note) => (
            <Card 
              ...
              className={cn(
                ...
                note.is_pinned && "border-[#022172] border-2"
              )}
            ...
            >
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-2">
                    {note.is_pinned && (
                      <Pin className="h-5 w-5 text-[#022172] mt-0.5" />
                    )}
                    <div>
                  ...
                  {note.is_pinned && (
                    <Badge className="bg-[#022172]">Pinned</Badge>
                  )}
                </div>
              </CardHeader>
              ...
              <CardContent>
                  ...
                  <div className="mt-4 pt-4 border-t space-y-3">
                    {note.file_url && (
                      <a 
                        ...
                        className="flex items-center gap-2 text-sm text-[#022172] hover:underline"
                ...
                {expandedNote !== note.id && note.content.length > 200 && (
                  <Button variant="link" className="p-0 h-auto mt-2 text-[#022172]">
                    Read more...
                  </Button>
                )}
              </CardContent>
