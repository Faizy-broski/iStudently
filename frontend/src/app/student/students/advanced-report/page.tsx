...
export default function StudentAdvancedReportPage() {
  ...
  const generateReport = () => {
    ...
    router.push(`/student/students/advanced-report/results?fields=${encodeURIComponent(JSON.stringify(selectedFields))}`)
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Select fields to include in your personal report</p>
      </div>
