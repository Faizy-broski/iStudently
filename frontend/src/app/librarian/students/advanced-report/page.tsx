...
export default function LibrarianAdvancedReportPage() {
  ...
  const generateReport = () => {
    ...
    router.push(`/librarian/students/advanced-report/results?fields=${encodeURIComponent(JSON.stringify(selectedFields))}`)
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Select fields to include in your custom student report</p>
      </div>
