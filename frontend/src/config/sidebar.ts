...
const adminMenuItems: SidebarMenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { title: "utilities", href: "#", icon: Settings, isLabel: true },
      { title: "recalculate_daily_attendance", href: "/admin/attendance/fix-daily", icon: RefreshCw },
      { title: "delete_duplicate_attendance", href: "/admin/attendance/duplicate", icon: AlertCircle },
      { title: "setup", href: "#", icon: Settings, isLabel: true },
