...
const adminMenuItems: SidebarMenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { title: "reports", href: "#", icon: BarChart3, isLabel: true },
      { title: "category_breakdown", href: "/admin/performance/reports/category-breakdown", icon: BarChart3 },
      { title: "breakdown_over_time", href: "/admin/performance/reports/category-breakdown-time", icon: TrendingUp },
      { title: "breakdown_by_staff_field", href: "/admin/performance/reports/breakdown-staff-field", icon: Users },
      { title: "performance_log", href: "/admin/performance/reports/log", icon: FileText },
    ],
  },

  {
    ...
    icon: UserPlus,
    subItems: [
      { title: "signup_links", href: "/admin/signup-links", icon: Link2 },
      { title: "pending_approvals", href: "/admin/pending-approvals", icon: UserCheck },
    ],
  },
  {
    title: "parents",
