// Vendored from thebuggeddev/anatomy (app/lib/anatomy-data.ts) for the
// "anatomy_label" quiz question type. Only the model paths were repointed
// to /anatomy/models/ (studently's namespaced public asset path).
...
export const organStructures: OrganStructure[] = [
  {
    id: "heart",
    model: "/anatomy/models/heart.glb",
    icon: "♥",
    accent: "#ee7c6a",
    illustrated: true,
    scientificName: "Cor",
  ...
  {
    id: "brain",
    model: "/anatomy/models/brain.glb",
    icon: "◉",
    accent: "#c58696",
    illustrated: true,
  ...
  {
    id: "lungs",
    model: "/anatomy/models/lungs.glb",
    icon: "◍",
    accent: "#dd8f8b",
    illustrated: true,
  ...
  {
    id: "liver",
    model: "/anatomy/models/liver.glb",
    icon: "≈",
    accent: "#b86858",
    illustrated: true,
  ...
  {
    id: "kidneys",
    model: "/anatomy/models/kidneys.glb",
    icon: "∞",
    accent: "#c96963",
    illustrated: true,
  ...
  {
    id: "eyeball",
    model: "/anatomy/models/eyeball.glb",
    icon: "⊙",
    accent: "#7294b9",
    illustrated: true,
  ...
  {
    id: "intestine",
    model: "/anatomy/models/intestine.glb",
    icon: "§",
    accent: "#d78b77",
    illustrated: true,
  ...
  {
    id: "pancreas",
    model: "/anatomy/models/pancreas.glb",
    icon: "◈",
    accent: "#c69a5e",
    illustrated: true,
