...
router.post('/validate-change', requireAdmin, timetableController.validateScheduleChange)
router.post('/ensure-grade-section', requireAdmin, timetableController.ensureGradeSection)
