...
import qirtasiCurriculumRoutes from "./routes/qirtasi/curriculum.routes";
import qirtasiFacetsRoutes from "./routes/qirtasi/facets.routes";
import qirtasiWorksheetsRoutes from "./routes/qirtasi/worksheets.routes";
...
import customFieldCategoryOrderRoutes from "./routes/custom-field-category-order.routes";
import exportTemplatesRoutes from "./routes/export-templates.routes";
...
import markingPeriodGroupsRoutes from "./routes/marking-period-groups.routes";
...
import resourceLinkCategoriesRoutes from "./routes/resource-link-categories.routes";
...
import vaultCategoriesRoutes from "./routes/vault/categories.routes";
...
import userAgreementRoutes from "./routes/user-agreement.routes";
...
import embeddedResourceCategoriesRoutes from "./routes/embedded-resource-categories.routes";
...
registerRoutes("/login-page-config", loginPageConfigRoutes);
...
registerRoutes("/qirtasi/curriculum", qirtasiCurriculumRoutes);
registerRoutes("/qirtasi/facets", qirtasiFacetsRoutes);
registerRoutes("/qirtasi/worksheets", qirtasiWorksheetsRoutes);
...
registerRoutes("/export-templates", exportTemplatesRoutes);
registerRoutes("/default-field-orders", defaultFieldOrderRoutes);
registerRoutes("/custom-field-category-orders", customFieldCategoryOrderRoutes);
...
registerRoutes("/user-agreements", userAgreementRoutes);
registerRoutes("/two-fa", twoFARoutes);
...
registerRoutes("/certificate-templates", certificateTemplateRoutes);
...
registerRoutes("/marking-period-groups", markingPeriodGroupsRoutes);
...
registerRoutes("/resource-link-categories", resourceLinkCategoriesRoutes);
registerRoutes("/embedded-resources", embeddedResourcesRoutes);
registerRoutes("/embedded-resource-categories", embeddedResourceCategoriesRoutes);
registerRoutes("/feedback", feedbackRoutes);
...
registerRoutes("/vault/categories", vaultCategoriesRoutes);
